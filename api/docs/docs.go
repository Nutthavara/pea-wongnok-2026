...
const docTemplate = `{
        ...
        "/recipes": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "กรองสูตรอาหารตามสถานะรายการโปรดของผู้ใช้ปัจจุบัน: true = เฉพาะที่ถูกใจไว้, false = เฉพาะที่ไม่ได้ถูกใจไว้",
                        "name": "favorite",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_recipe.ReplaceRecipeRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_recipe.ReplaceRecipeRequest": {
            "type": "object",
            "required": [
                "description",
                "difficultyId",
        ...
        "internal_user.UpdateUserRequest": {
            ...
            "properties": {
                "bio": {
                    "type": "string",
                    "example": "Home cook who loves spicy food."
                },
                "imageUrl": {
                    "type": "string",
        ...
        "internal_user.UserResponse": {
            ...
            "properties": {
                ...
                "id": {
                    "type": "string",
                    "example": "3f0c1a7e-2b19-4c5e-9f3a"
                },
                "imageUrl": {
                    "type": "string",
                    "example": "https://images.example.com/avatar.jpg"
